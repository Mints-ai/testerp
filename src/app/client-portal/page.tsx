...
import { Briefcase, FileDown, CheckCircle2, Banknote, Calendar, CreditCard, Lock, Check, Loader2 } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const fetchClientData = async () => {
      try {
        ...
        let fetchedProjects = projSnap.docs.map(doc => ({ id: doc.id, ...doc.data() })) as Project[];
        let fetchedInvoices = invSnap.docs.map(doc => ({ id: doc.id, ...doc.data() })) as Invoice[];
